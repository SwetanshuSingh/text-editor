    ...
    >
      ...
      >
        ...
        <motion.button
          ...
          className="absolute bottom-4 right-4 w-10 h-10 flex justify-center items-center bg-white rounded-full p-0.5"
        >
          <span className="w-full h-full bg-gray-200/60 flex justify-center items-center rounded-full">
            <AssistantIcon />
          </span>
        </motion.button>
      </motion.section>
